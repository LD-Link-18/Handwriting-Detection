...
if __name__ == "__main__":
    ...
    words_txt_path = r"C:\Users\dikil\Desktop\crnn\ascii\words.txt"
    ...
    loader = DataLoader(IAMWordsDataset(words_data, words_img_dir, char_to_num), 
    ...
    print("Stage 1.5: Pro Words Training Started (GPU & Augmentation)")
    best_loss = float('inf')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if avg_loss < best_loss:
            best_loss = avg_loss
            torch.save(model.state_dict(), "words_model_best_v2.pth")
            print(f"New Record: Best model saved to words_model_best_v2.pth (Loss: {best_loss:.4f})")
            
        torch.save(model.state_dict(), "words_model.pth")